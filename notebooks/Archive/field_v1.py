class Field():
    ...
    def __init__(self, file_name):
        ...
        self.file = file_name
        self.field_info = self.__import_field(file_name)
        self.field_ID = self.field_info["fieldId"]
        self.name = self.field_info["name"]
        self.description = self.field_info["description"]
        self.machine_type = self.field_info["machineType"]
        self.machine_name = self.field_info["machineName"]
        self.type = self.field_info["type"]
        self.mq_type = self.field_info["mqType"]
        self.isocentre = self.field_info["isocentre"]
        self.beam_meterset = self.field_info["beamMeterset"]
        self.mq_control_points = self.field_info["mqControlPoints"]
        self.beam_energy = self.field_info["beamEnergy"]
        self.is_fff = self.field_info["isFff"]
        self.bolus_status = self.field_info["bolusStatus"]
        self.has_bolus = self.field_info["hasBolus"]
    ...
    def __set_gantry_total_areas(self):
        self.gantry_total_areas = self.areas_matrix.sum()
        return 

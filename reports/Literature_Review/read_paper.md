...
### 4️⃣ GRI-2021-29669 - VMAT Complexity Analysis
- **📄 Title**: Complexity Analysis of VMAT Prostate Plans
- - **🔗 DOI**: [10.1002/mp.15128](https://doi.org/10.1002/mp.15128)
- **🔍 Summary**:
  - Evaluated **217 VMAT prostate treatment plans** for complexity.
  - Found that **Leaf Travel (LT), Circumference/Area Ratio (CoA), and MCS** are **strong predictors of QA failures**.
  - Showed that **Monitor Units (MU) is not a reliable complexity metric**.
